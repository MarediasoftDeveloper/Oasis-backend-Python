...
QR_BASE_URL = "https://web-production-65f6f.up.railway.app"  # Replace with your actual base URL for QR codes
...
FIREBASE_CRED = json.loads(config('FIREBASE_CREDENTIALS'))
