...
import re
from venue.Serializers.venue_signup_serializer import Venue_SignUp_Serializer_Staff


class VenueInfoStaffSerializer(serializers.ModelSerializer):
    ...
    venue= Venue_SignUp_Serializer_Staff(read_only=True)
