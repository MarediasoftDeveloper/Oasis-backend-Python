...
#                 step_record.points_awarded += trail_step.step_reward_points
#                 step_record.save()
...
#                         True
#                         if step_record.points_awarded > 0
#                         else False
#                     ),

#                     "step_points_awarded": (
#                         step_record.points_awarded
#                         if step_record.points_awarded > 0
#                         else None
#                     ),
...
class UserTrailRecordSave(viewsets.GenericViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        if trail.badge_id is not None:
            ...
            #
            # Existing logic:
            # Badge level depends on completed steps
            # of the current TrailRecord.
            # ==================================================

            if not trail.is_garden:
            ...
            # GARDEN TRAIL
            #
            # Badge level depends on ALL distinct completed
            # garden trails belonging to this user.
            #
            # 25 gardens = final level 5.
            # ==================================================
                ...
                garden_progress_percentage = min(
                    100,
                    round(
                        (
                            completed_garden_count
