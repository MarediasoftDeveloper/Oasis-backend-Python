...
def UseReferralCode(id, referral_code):
    ...
    record_earned_points(referral.referral_code_sender, referral.referral_code_user, get_points)
    update_customer_profiles_after_refferal_completion(referral.referral_code_sender, referral.referral_code_user, get_points)
