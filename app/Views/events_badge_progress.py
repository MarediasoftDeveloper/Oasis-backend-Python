...
class EventBadgeProgressView(APIView):
    ...
    def post(self, request):
        ...
        if not earned_badges_qs:
            return Response({"data":BadgesLevelSerializer(badge_levels, many=True).data , "message":"you haven't attended this event, please attend this event and achieve challenges to achieve this badge."})
        ...
        if challenges and earned_badges_qs and user_joined_event:
            challenges_achieved_list = Challenge_Achiever.objects.filter(
                ...
                scanned_at__gte=user_joined_event.joined_at
            )
