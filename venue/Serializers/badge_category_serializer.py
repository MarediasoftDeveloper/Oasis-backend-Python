...
class BadgesCategorySerializer(serializers.ModelSerializer):
    ...
    def validate_category(self, value):
        ...
        if not value or not value.strip():
            raise serializers.ValidationError("Badge Category cannot be empty.")
        return value
    ...
    def validate_num_of_task_to_achieve_badge(self, value):
        ...
        if value <= 0:
            raise serializers.ValidationError("Number of tasks to achieve badge must be greater than 0.")
        return value